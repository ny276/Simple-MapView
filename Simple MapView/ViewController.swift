...
//  Simple MapView
//
//  Created by D7703_03 on 2018. 6. 5..
...
class ViewController: UIViewController {
    ...
    var foodStoreNamTel = ["051-863-6997",
                           "051-852-9969",
                           "051-852-9969",
                           "051-852-9969",
                           "051-852-9969",
        ...
        for addr in foodStoreAddress {
            ...
            geocoder.geocodeAddressString(addr) {
                (placemarks: [CLPlacemark]?, error: Error?) -> Void in
                  ...
                  pin.coordinate = loc!
                  pin.title = self.foodStoreAddress[self.count]
                  pin.subtitle = self.foodStoreNamTel[self.count]
